...
export class WRDToast extends LitElement {
    constructor() {
        super();
...
window.WRDToast = function (content = "") {
    const toast = document.createElement("wrd-toast");
...
customElements.define('wrd-toast', WRDToast);
