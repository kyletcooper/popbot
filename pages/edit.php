    ...
    <div class="wrd-row">
        ...
        <main class="wrd-col-12 wrd-col-xl-8 wrd-col-xxl-7">
            ...
            <div class="wrd-section" style="padding:0;">
                <panel-opener icon="palette" label="Appearance">
                    <panel-appearance uuid="<?php esc_attr_e($popbot->get_uuid()); ?>"></panel-appearance>
                </panel-opener>

                <panel-opener icon="ads_click" label="Trigger">
                    <panel-trigger uuid="<?php esc_attr_e($popbot->get_uuid()); ?>"></panel-trigger>
                </panel-opener>

                <panel-opener icon="rule" label="Conditions">
                    <panel-conditions uuid="<?php esc_attr_e($popbot->get_uuid()); ?>"></panel-conditions>
                </panel-opener>

                <panel-opener icon="event" label="Visibility">
                    <panel-visibility uuid="<?php esc_attr_e($popbot->get_uuid()); ?>"></panel-visibility>
                </panel-opener>
        ...
        <aside class="wrd-col">
            ...
            <div class="wrd-section">
                <preview-bot uuid="<?php esc_attr_e($popbot->get_uuid()); ?>" scale="0.75" show-errors show-controls style="min-height: 50vh;"></preview-bot>
            </div>
        </aside>
