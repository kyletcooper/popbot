...
/**
 * Contains the Popbot_Assets class.
 */

namespace popbot;

/**
 * Handles all assets (scripts & css) across all various locations for PopBot.
 */
class Popbot_Assets {
	...
	public static function init() {
		...
		add_filter( 'script_loader_tag', array( static::class, 'defer_scripts' ), 10, 2 );
	}
